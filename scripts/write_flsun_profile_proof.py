...
from hermes_slicer.slicer import flsun_profile_inventory  # noqa: E402
...
def main() -> int:
    ...
    print(json.dumps({"status": inventory["status"], "targets": [item["model"] for item in inventory.get("targets", [])]}, indent=2))
