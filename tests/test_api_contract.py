...
class ApiContractTests(unittest.TestCase):
    def test_openapi_lists_all_bridge_routes(self) -> None:
        ...
        routes = {
            ...
            "/api/orca/flsun",
            "/api/agents",
            "/api/printers/targets",
            "/api/printers/observe",
            "/api/printers/safety-state",
            "/api/printers/safety-events/camera-frame",
            "/api/printers/safety-events/plate-classification",
            "/api/printers/hard-stop-proof",
            "/api/proof/recent",
