...
ACTIONS = {
    ...
    "printer_safety_state": ("POST", "/api/printers/safety-state"),
    "printer_safety_camera_frame": ("POST", "/api/printers/safety-events/camera-frame"),
    "printer_safety_plate_classification": ("POST", "/api/printers/safety-events/plate-classification"),
    "printer_hard_stop_proof": ("POST", "/api/printers/hard-stop-proof"),
